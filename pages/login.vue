...
async function entrar() {
  ...
  try {
    ...
    // Redireciona diretamente — store já está populada
    const destino = auth.usuario?.primeiro_acesso
      ? "/primeiro-acesso"
      : "/dashboard";
...
<template>
  <div class="w-full max-w-md">
    <div class="text-center mb-8">
      <div
        class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-600 mb-4 shadow-lg shadow-blue-200"
      >
